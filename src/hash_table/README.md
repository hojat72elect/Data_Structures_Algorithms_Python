...
A hash table (hash map) is a data structure which implements an associative array abstract data type, a structure that
...
collisions must be accommodated in some way (there are multiple algorithms for collision handling).
